import { 
  ...
  FolderOpen, ThumbsUp, ShieldCheck, Zap, Users, BarChart2, Database
} from "lucide-react";
...
export default function TemplatesMarketplace({ onBack, onNavigate, user, isEmbedded = false, isDark = true }) {
  ...
  useEffect(() => {
    try {
      const SEED_BLUEPRINTS = [
        {
          id: "bp_arch_youtube",
          title: "YouTube Video Transcoding & CDN Streaming Engine",
          category: "hld",
          tool: "HLD Architecture",
          route: "whiteboard_load",
          ratio: "16:9",
          aspectLabel: "1920 × 1080",
          image: whiteboardPreviewImg,
          creator: { name: "System Architects", badge: "Production Reference", avatar: "▶️" },
          remixes: 1420,
          likes: 890,
          rating: 5.0,
          ratingsCount: 184,
          tags: ["HLD", "Transcoding", "HLS", "Kafka", "Blob Store", "CDN"],
          colors: ["#e1496d", "#38bdf8", "#10b981"],
          layers: 16,
          desc: "Complete production-ready high-level architecture with API Gateway, chunk upload splitters, FFmpeg worker pools, and Edge CDN caching.",
          isUserPublished: false,
          publishedAt: "2026-08-20"
        },
        {
          id: "bp_arch_uber",
          title: "Uber Real-Time Geohashing & Driver Matching",
          category: "hld",
          tool: "HLD Architecture",
          route: "whiteboard_load",
          ratio: "16:9",
          aspectLabel: "1920 × 1080",
          image: whiteboardPreviewImg,
          creator: { name: "Distributed Core", badge: "Production Reference", avatar: "🚗" },
          remixes: 1180,
          likes: 740,
          rating: 4.9,
          ratingsCount: 142,
          tags: ["HLD", "Geohash", "Redis", "WebSocket", "Ring Buffer", "QuadTree"],
          colors: ["#38bdf8", "#e1496d", "#a855f7"],
          layers: 14,
          desc: "Low-latency location ingestion using Redis Geospatial indexes, H3 hexagonal cells, WebSocket gateway, and dynamic surge pricing queues.",
          isUserPublished: false,
          publishedAt: "2026-08-20"
        },
        {
          id: "bp_arch_stripe",
          title: "Stripe Idempotent Multi-Payment Gateway LLD",
          category: "lld",
          tool: "LLD & UML",
          route: "infinite_studio",
          ratio: "16:9",
          aspectLabel: "1920 × 1080",
          image: docPreviewImg,
          creator: { name: "FinTech Engineering", badge: "Production Reference", avatar: "💳" },
          remixes: 950,
          likes: 620,
          rating: 5.0,
          ratingsCount: 119,
          tags: ["LLD", "UML", "Idempotency", "Design Patterns", "State Machine"],
          colors: ["#38bdf8", "#10b981", "#e1496d"],
          layers: 12,
          desc: "Type-safe class hierarchy with IPaymentEngine interface, atomic idempotency lock handler, exponential retry policies, and webhook verification.",
          isUserPublished: false,
          publishedAt: "2026-08-20"
        },
        {
          id: "bp_arch_postgres_saas",
          title: "Multi-Tenant B2B SaaS Database ERD Schema",
          category: "erd",
          tool: "Database ERD",
          route: "whiteboard_load",
          ratio: "16:9",
          aspectLabel: "1920 × 1080",
          image: docPreviewImg,
          creator: { name: "Database Guild", badge: "Production Reference", avatar: "🗄️" },
          remixes: 1310,
          likes: 810,
          rating: 4.9,
          ratingsCount: 165,
          tags: ["Database ERD", "PostgreSQL", "Prisma", "RLS", "JSONB", "Indexes"],
          colors: ["#10b981", "#38bdf8", "#f59e0b"],
          layers: 18,
          desc: "Relational schema with organization workspaces, RBAC permissions, audit logging, composite primary keys, and Prisma ORM generator.",
          isUserPublished: false,
          publishedAt: "2026-08-20"
        },
        {
          id: "bp_arch_rate_limiter",
          title: "RFC-084: Distributed Token Bucket Rate Limiter",
          category: "rfc",
          tool: "RFC Docs",
          ...
          aspectLabel: "1920 × 1080",
          image: docPreviewImg,
          creator: { name: "Staff RFC Council", badge: "Production Reference", avatar: "📄" },
          remixes: 820,
          likes: 490,
          rating: 4.9,
          ratingsCount: 94,
          tags: ["RFC Spec", "Lua Script", "Redis", "Leaky Bucket", "SLA p99"],
          colors: ["#ec4899", "#38bdf8", "#10b981"],
          layers: 10,
          desc: "Engineering architecture decision spec detailing atomic Redis Lua script token consumption, sliding window log vs token bucket benchmarks.",
          isUserPublished: false,
          publishedAt: "2026-08-20"
        },
        {
          id: "bp_arch_kafka_stream",
          title: "Kafka Clickstream Analytics & Flink DAG Pipeline",
          category: "pipelines",
          ...
          aspectLabel: "1920 × 1080",
          image: aiPreviewImg,
          creator: { name: "Data Platform", badge: "Production Reference", avatar: "⚡" },
          remixes: 760,
          likes: 530,
          rating: 4.8,
          ratingsCount: 88,
          tags: ["Pipelines", "Kafka", "Flink", "S3 Parquet", "ClickHouse"],
          colors: ["#f97316", "#e1496d", "#a855f7"],
          layers: 15,
          desc: "Real-time streaming pipeline topology with Schema Registry validation, tumbling window aggregators, and ClickHouse columnar storage.",
          isUserPublished: false,
          publishedAt: "2026-08-20"
        },
        {
          id: "bp_arch_review_deck",
          title: "Netflix Global Failover & Resiliency Sprint Review",
          category: "decks",
          tool: "System Decks",
          ...
          aspectLabel: "1920 × 1080",
          image: pptPreviewImg,
          creator: { name: "Reliability Engineering", badge: "Production Reference", avatar: "📊" },
          remixes: 640,
          likes: 410,
          rating: 5.0,
          ratingsCount: 76,
          tags: ["Slide Deck", "Chaos Monkey", "Multi-Region", "SLA 99.999%"],
          colors: ["#a855f7", "#e1496d", "#38bdf8"],
          layers: 11,
          desc: "Engineering presentation deck with capacity models, RTO/RPO metrics, and active-active multi-region failover sequence slides.",
          isUserPublished: false,
          publishedAt: "2026-08-20"
        }
      ];
  ...
  const categories = [
    { id: "all", label: "All Architectures", icon: Globe },
    { id: "hld", label: "Cloud HLD Topologies", icon: Layers },
    { id: "lld", label: "LLD & UML Class Diagrams", icon: Cpu },
    { id: "erd", label: "Database ERD Schemas", icon: Database },
    { id: "pipelines", label: "Distributed Event DAGs", icon: Zap },
    { id: "rfc", label: "Engineering RFC Specs", icon: FileText },
    { id: "decks", label: "System Design Decks", icon: Presentation },
  ];
